...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .demo-cred { display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px; }
    ...
    .demo-value:hover { background: #f0fdf4; border-color: var(--primary); color: var(--primary); }
...
<body>
  ...
  <div class="left-panel">
    ...
    <div class="left-hero">
      ...
      <h1 class="hero-title">
        Modern care,<br>
        <span>smarter</span> management.
      </h1>
      <p class="hero-desc">
        Complete dental clinic management — patients, appointments, records, finance and reports in one elegant platform.
      </p>
    </div>
    ...
    <div class="login-box">
      ...
      <div class="demo-box">
        ...
        <div class="demo-cred">
          ...
          <span class="demo-value" onclick="fillEmail(this)">admin@dentalcare.com</span>
        </div>
        <div class="demo-cred">
          <span class="demo-label">Password</span>
          <span class="demo-value" onclick="fillPassword(this)">password</span>
        </div>
      </div>
